common /C1/x,z,i,w
integer x(10,100,2),z(2),i,j,N,w(5,2)
real a(5) logical ll,yy(10)
string s,s_str_(10)
data x/2000/,z/2,-9/,N/0x3FC70/
$data a/0.314159e-31,0.2e-30,0.272/,ll/.false./,yy/.false.,*.true.,.true./
$data w/5.,20.,4.,-2.,0.3,*0./
data s_str_/"string1", *"string2", "string3"/
$ no comment
100 yy(z) = .not. ll .and. .not. x(10,i,g(j)).gt.y(z) .or. z .eq. 0xa11
call aa
...
if (yy(i)) goto 1000
if (a(1).gt.0.01.and.b(0,a*k**i).and.g(m(i)).lt.x(i,i+2,g(j))) then
   integer z,a(10)
   101 read z,a(z)
...
102 call try_me_(x(i,int(ll),z),m,length(s))
